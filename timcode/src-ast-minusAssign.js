...
/**/if( CHECK )
/**/{
/**/	if( timModules.ast_minusAssign !== undefined )
/**/	{
/**/		throw new Error( );
/**/	}
/**/}

	timModules.ast_minusAssign = ast_minusAssign;
}
...
ast_minusAssign.prototype = prototype;


/*
| Creates a new minusAssign object.
*/
ast_minusAssign.create =
prototype.create =
	function(
		// free strings
	)
...
| Type reflection.
*/
prototype.timtype = ast_minusAssign;
