...
if( NODE )
{
	jion$ast_preIncrement = module.exports;
}
else
{
	jion$ast_preIncrement = { };
...
jion$ast_preIncrement.prototype = prototype;


/*
| Creates an preIncrement object.
*/
jion$ast_preIncrement.abstract =
