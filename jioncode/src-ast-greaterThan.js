...
if( NODE )
{
	jion$ast_greaterThan = module.exports;
}
else
{
	jion$ast_greaterThan = { };
...
jion$ast_greaterThan.prototype = prototype;


/*
| Creates an greaterThan object.
*/
jion$ast_greaterThan.abstract =
