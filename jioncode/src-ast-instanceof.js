...
if( NODE )
{
	jion$ast_instanceof = module.exports;
}
else
{
	jion$ast_instanceof = { };
...
jion$ast_instanceof.prototype = prototype;


/*
| Creates an instanceof object.
*/
jion$ast_instanceof.abstract =
