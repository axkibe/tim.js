...
if( NODE )
{
	jion$ast_plusAssign = module.exports;
}
else
{
	jion$ast_plusAssign = { };
...
jion$ast_plusAssign.prototype = prototype;


/*
| Creates an plusAssign object.
*/
jion$ast_plusAssign.abstract =
