...
if( NODE )
{
	jion$ast_objLiteral = module.exports;
}
else
{
	jion$ast_objLiteral = { };
...
jion$ast_objLiteral.prototype = prototype;


/*
| Creates an objLiteral object.
*/
jion$ast_objLiteral.abstract =
